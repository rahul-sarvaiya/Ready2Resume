...
export default class Resume extends Component {
  componentDidMount(){
    axios({
      url:'https://api.github.com/repos/SANJAY072000/resumeBuilder'
    })
    .then(res=>{
    axios({
  ...
  render(){
    return(
      ...
      <button id="printPage" className='btn btn-danger btn-sm' onClick={()=>window.print()}  style={{color: "#fff",backgroundColor:'#4CAF50', margin: 10 ,padding:"13px",borderRadius:"50%"}}>
      ...
      <hr/>
          ...
          <hr/>
            <div className='row mt-5'>
            <div className='col-md-3'>
            <h4 className='pl-3 font-weight-bolder mt-2 d-none d-md-block'>Skills</h4>
            <h4 className='pl-3 font-weight-bolder d-block d-md-none'>Skills</h4>
            </div>
            <div className='col-md-9'>
      ...
      return (<li key={i}></li>);
            ...
            <div className='row mt-5'>
            <div className='col-md-3'>
            <h4 className='pl-3 font-weight-bolder mt-2 d-none d-md-block'>Projects</h4>
            <h4 className='pl-3 font-weight-bolder d-block d-md-none mb-3'>Projects</h4>
            </div>
            <div className='col-md-9'>
            ...
            <div className='row mt-5'>
            <div className='col-md-3'>
            <h4 className='pl-3 font-weight-bolder mt-2 d-none d-md-block'>Experienced in:</h4>
            <h4 className='pl-3 font-weight-bolder d-block d-md-none'>Experienced in:</h4>
            </div>
            <div className='col-md-9'>
